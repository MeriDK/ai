...
robots = generate_random_robots(n)
...
def create_robots():
    ...
    # everything is ok so we can decrease n
    new_n = 100
...
print(sum(r.x for r in robots) / n, end=' ')
print(sum(r.y for r in robots) / n)

print('time', time() - start, 'sec')
answers = [[2.99802, 3.03753], [1.9406, 8.00725], [1.59266, 8.63027], [3.62952, 15.1485]]
print(sum(r.x for r in robots) / n - answers[test_num - 1][0])
print(sum(r.y for r in robots) / n - answers[test_num - 1][1])
